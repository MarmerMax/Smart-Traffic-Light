...
//                    System.out.println(changing_time);
    ...
    private int[] calculatePassedCars(int first_speed_1, int second_speed_1, int first_speed_2, int second_speed_2, Queue<Car> first_cars_1, Queue<Car> second_cars_1, Queue<Car> first_cars_2, Queue<Car> second_cars_2) {
