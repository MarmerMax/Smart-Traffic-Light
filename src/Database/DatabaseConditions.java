...
public class DatabaseConditions {
    ...
    private String better_distribtuion; // "15:5->10:10..."
    
    public DatabaseConditions(int[] cars_first_crossroad, int[] cars_second_crossroad, int[] speed_limit_first_crossroad, 
    		int[] speed_limit_second_crossroad, int[] actual_speed_first_crossroad, int[] actual_speed_second_crossroad,
    		double initial_time, double better_time, double simulation_time, String better_distribtuion) {
    	...
    	this.better_distribtuion = better_distribtuion;
    }
